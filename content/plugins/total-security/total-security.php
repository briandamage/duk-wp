...
class Total_Security {
        public $min_wp_ver 	        = '4.3.1'; //
  		public $pluginversion 	    = '3.3.1';

        public $php_lastver 	    = '5.6.13'; // PHP - http://php.net/downloads.php
        public $mySQL_lastver 	    = '5.6.26'; // MYSQL - http://dev.mysql.com/downloads/
